...
**Goal:** As a release operator, I want to verify the exact deployed production origin, so that I can prove the Arabic release preserves its performance and search-discovery contracts without overstating external evidence.
**Mode:** mvp
**Depends on:** Phase 5
